...
import { experiences, hero, profiles, skill, socials, welcome } from "../content/data";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-2.5">
        <Hero hero={hero} profiles={profiles} className={layout.hero} />
        <Skills skill={skill} className={layout.skills} />
        <Experiences experiences={experiences} className={layout.experiences} />
        <ContactMe socials={socials} welcome={welcome} className={layout.contact} />
      </div>
    </main>
  );
}
